classdef SO3RiccatiObserver_vector < handle
    properties
        dt          
        R_hat       
        bias_hat    
    ...
    methods
        function obj = SO3RiccatiObserver_vector(R_hat, bias_hat, dt)
            obj.dt = dt;
        ...
        function correct(obj, b_1, b_2, b_meas_1, b_meas_2)      
            ...
            y = [y; - b_meas_1 + obj.R_hat'*b_1];
            C = [C; obj.R_hat' * skew(b_1), zeros(3,3)];
            

            y = [y; - b_meas_2 + obj.R_hat'*b_2];
            C = [C; obj.R_hat' * skew(b_2), zeros(3,3)];
